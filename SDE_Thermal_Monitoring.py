...
try:
    ...
    if len(verReconcileList) > 0:
        ...
        arcpy.ReconcileVersions_management(TMworkspace, "ALL_VERSIONS", TMtargetVersion, verReconcileList,
                                           "LOCK_ACQUIRED",
        ...
        *********************
        ...
        arcpy.AnalyzeDatasets_management(TMworkspace, "NO_SYSTEM", oDataList, "ANALYZE_BASE", "ANALYZE_DELTA",
                                         "ANALYZE_ARCHIVE")
    ...
    if len(verReconcileList) > 0:
        ...
        # Put log in a better place in the future
        arcpy.ReconcileVersions_management(TMworkspace, "ALL_VERSIONS", TMtargetVersion, verReconcileList,
                                           "LOCK_ACQUIRED", "NO_ABORT", "BY_OBJECT", "FAVOR_EDIT_VERSION", "POST",
                                           "KEEP_VERSION", "c:/temp/reconcilelog.txt")
