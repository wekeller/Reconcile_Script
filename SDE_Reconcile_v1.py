...
try:
    ...
    if len(verReconcileList) > 0:
        ...
        arcpy.ReconcileVersions_management(TMworkspace, "ALL_VERSIONS", targetVersion, verReconcileList, "LOCK_ACQUIRED",
    ...
    if len(verReconcileList) > 0:
        ...
        # Execute the ReconcileVersions tool.
        # Put log in a better place in the future
        arcpy.ReconcileVersions_management(TIworkspace, "ALL_VERSIONS", targetVersion, verReconcileList,
                                           "LOCK_ACQUIRED",
                                           "NO_ABORT", "BY_OBJECT", "FAVOR_EDIT_VERSION", "POST", "KEEP_VERSION",
                                           "c:/temp/reconcilelog.txt")
        ...
        *********************
        ...
        arcpy.AnalyzeDatasets_management(workspace, "NO_SYSTEM", oDataList, "ANALYZE_BASE", "ANALYZE_DELTA",
                                         "ANALYZE_ARCHIVE")
...
########### Reconcile Signage Database ###########
    ...
    if len(verReconcileList) > 0:
        ...
        # Execute the ReconcileVersions tool.
        # Put log in a better place in the future
        arcpy.ReconcileVersions_management(Sworkspace, "ALL_VERSIONS", targetVersion, verReconcileList, "LOCK_ACQUIRED",
                                           "NO_ABORT", "BY_OBJECT", "FAVOR_EDIT_VERSION", "POST", "KEEP_VERSION",
                                           "c:/temp/reconcilelog.txt")
...
########### Reconcile Temporary Projects Database ###########
    ...
    if len(verReconcileList) > 0:
        ...
        # Execute the ReconcileVersions tool.
        # Put log in a better place in the future
        arcpy.ReconcileVersions_management(TPworkspace, "ALL_VERSIONS", targetVersion, verReconcileList, "LOCK_ACQUIRED",
                                           "NO_ABORT", "BY_OBJECT", "FAVOR_EDIT_VERSION", "POST", "KEEP_VERSION",
                                           "c:/temp/reconcilelog.txt")
