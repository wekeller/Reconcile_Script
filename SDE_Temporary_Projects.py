...
try:
    ...
    if len(verReconcileList) > 0:
        ...
        arcpy.ReconcileVersions_management(TPworkspace, "ALL_VERSIONS", TPtargetVersion, verReconcileList,
                                           "LOCK_ACQUIRED",
        ...
        arcpy.AnalyzeDatasets_management(TPworkspace, "SYSTEM", "", "ANALYZE_BASE", "ANALYZE_DELTA",
                                         "ANALYZE_ARCHIVE")
        ...
        *********************
        ...
        arcpy.AnalyzeDatasets_management(TPworkspace, "NO_SYSTEM", oDataList, "ANALYZE_BASE", "ANALYZE_DELTA",
                                         "ANALYZE_ARCHIVE")
